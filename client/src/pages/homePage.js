    ...
    return (
      ...
      <div>
        ...
        <div className="layoutRoot">
          ...
          <ResizableBox className="box-box3a" height={this.state.height} width={this.state.width} onResize={this.onResize} lockAspectRatio={true} resizeHandles={['sw', 'se', 'nw', 'ne', 'w', 'e', 'n', 's']}>
          ...
          <ResizableBox className="box-box3b" height={this.state.height} width={this.state.width} onResize={this.onResize} lockAspectRatio={true} resizeHandles={['sw', 'se', 'nw', 'ne', 'w', 'e', 'n', 's']}>
            <div className="box" style={{width: this.state.width + 'px', height: this.state.height + 'px'}}>
            </div>
