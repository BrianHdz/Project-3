        ...
        <div className="container-fluid">
          <Row>
            <Col style={{ maxWidth: 200 }} size="md-4" className="mt-3 p-3">
              <a href="https://spotifyapi1.herokuapp.com/">
            ...
            <Col className="mt-3 p-3" size="md-4">
              <button
                type="button"
                className="btn btn-dark d-block mt-3"
              ...
              <div
                ...
                style={{ maxWidth: 400, maxHeight: 450 }}
              >
                      ...
                      return (
                        <li className="list-group-item">
                          ...
                          <button
                            ...
                            onClick={() => this.getId(featuredItem.uri)}
                            key={featuredItem.uri}
                      ...
                      return (
                        <li className="list-group-item">
                          ...
                          <button
                            ...
                            onClick={() => this.getId(searchedItems.uri)}
                            key={searchedItems.uri}
